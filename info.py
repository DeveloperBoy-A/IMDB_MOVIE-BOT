...
PRIME_LOGO = (environ.get('PRIME_LOGO', 'https://iili.io/2H7Ijyl.jpg'))
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','its_ankit_meena907') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','newmoviesonlyfree9') # WITHOUT @
...
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "newmoviewebseries_group") #[ without @ ]
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', '33d3046c5fa6900b043b04926fb53d2adfdf6347')
...
# rip paid developers 🤣 - >> No need to buy paid source code while @LazyDeveloperr is here 😍😍import re
from os import getenv, environ
import logging
...
LOG_STR += (f"MAX_LIST_ELM Found, long list will be shortened to first {MAX_LIST_ELM} elements\n" if MAX_LIST_ELM else "Full List of casts and crew will be shown in imdb template, restrict them by adding a value to MAX_LIST_ELM\n")
LOG_STR += f"Your current IMDB template is {IMDB_TEMPLATE}"
# Credit DeveloperBoy-A.
# Please Don't remove credit.
# Born to make history DeveloperBoy-A !
